...
export default function NavBar() {
  return (
    <header className="sticky top-0 z-50 h-[60px] border-b border-esg-border bg-white/95 backdrop-blur-sm">
      <div className="mx-auto flex h-full max-w-esg-content items-center justify-between px-4 sm:px-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold tracking-tight">
            <span className="text-esg-dark-bg">ESGPro</span>
            <span className="text-esg-green"> Mastery</span>
          </span>
        </div>
        <a
          href={CTA_URLS.nav}
